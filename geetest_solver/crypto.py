...
pt0 / pt1 / pt2 と td_sign をここにまとめています。
"""
...
def _rsa_encrypt(key_bytes: bytes) -> bytes:
    # RSA PKCS#1 v1.5
    # pycryptodome がなければ pure Python fallback
    try:
        ...
        # manual PKCS#1 v1.5 padding + pow()
        n = int(RSA_N_HEX, 16)
        k = (n.bit_length() + 7) // 8
